...
2. In the jumbotron `div`, create a [📜 bootstrap input group](https://getbootstrap.com/docs/4.5/components/input-group/). 
   ...
   * Input Group will also contain a add-on icon representing a user.
     * 🦉: The [FontAwesome Website]((https://fontawesome.com/icons/user?style=solid)) will show you all the different icons you can choose from and the HTML line you need to use for a user icon.
