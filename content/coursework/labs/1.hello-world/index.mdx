...
By completing this tutorial, you've learned to create a repository and make a pull request on GitHub.

* You can start adding collaborators to your repository. who would follow a similar approach, of creating branches, making changes, and merging them into the main branch.
